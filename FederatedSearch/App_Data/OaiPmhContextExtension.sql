...
/****** Fulltext Catalog ******/
CREATE FULLTEXT CATALOG [metadata_catalog]
    WITH ACCENT_SENSITIVITY = OFF
    AUTHORIZATION [dbo];
GO

/****** Fulltext Index ******/
CREATE FULLTEXT INDEX ON [dbo].[Metadata]
    ([Title] LANGUAGE 1033, [Creator] LANGUAGE 1033, [Subject] LANGUAGE 1033, [Description] LANGUAGE 1033, [Contributor] LANGUAGE 1033, [Publisher] LANGUAGE 1033, [Type] LANGUAGE 1033, [Format] LANGUAGE 1033, [Identifier] LANGUAGE 1033, [Source] LANGUAGE 1033, [Language] LANGUAGE 1033, [Relation] LANGUAGE 1033, [Coverage] LANGUAGE 1033, [Rights] LANGUAGE 1033)
    KEY INDEX [PK_dbo.Metadata]
    ON [metadata_catalog];
GO

/****** User-Defined Table Type ******/
CREATE TYPE [dbo].[RecIdList] AS TABLE (
